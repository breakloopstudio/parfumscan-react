...
const s = StyleSheet.create({
  ...
  fieldLabel: { fontSize: 13, fontWeight: '500', color: theme.colors.text, marginTop: 4 },
  ...
  pickTextActive: { color: theme.colors.primary, fontWeight: '500' },
  ...
  chipText: { fontSize: 12, fontWeight: '500', color: theme.colors.violetInk },
