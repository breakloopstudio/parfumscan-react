...
const s = StyleSheet.create({
  ...
  iconCircle: { width: 72, height: 72, borderRadius: 36, backgroundColor: theme.colors.primarySoft, justifyContent: 'center', alignItems: 'center', alignSelf: 'center', marginBottom: 12 },
  header: { alignItems: 'center', marginBottom: 28 },
  title: { fontFamily: 'PlayfairDisplay_700Bold', fontSize: 32, color: theme.colors.text, letterSpacing: -0.5 },
  subtitle: { fontFamily: 'Inter_400Regular', fontSize: 15, color: theme.colors.textMuted, marginTop: 4 },
  ...
  googleText: { fontFamily: 'Inter_500Medium', fontSize: 15, color: theme.colors.text },
  divider: { flexDirection: 'row', alignItems: 'center', marginBottom: 20 },
  dividerLine: { flex: 1, height: 1, backgroundColor: theme.colors.border },
  dividerText: { paddingHorizontal: 16, fontFamily: 'Inter_400Regular', fontSize: 13, color: theme.colors.textMuted },
  inputGroup: { marginBottom: 12 },
  input: { borderRadius: theme.radius.base, backgroundColor: theme.colors.surface, borderWidth: 1, borderColor: theme.colors.border, paddingHorizontal: 12, height: 48, fontFamily: 'Inter_400Regular', fontSize: 15, color: theme.colors.text },
  errorBox: { backgroundColor: theme.colors.overpricedSoft, borderRadius: 10, padding: 10, marginTop: -4, marginBottom: 8 },
  errorText: { fontFamily: 'Inter_400Regular', fontSize: 13, color: theme.colors.overpriced },
  ...
  linkText: { fontFamily: 'Inter_400Regular', fontSize: 14, color: theme.colors.textMuted },
  linkBold: { fontFamily: 'Inter_600SemiBold', color: theme.colors.primary },
});
