...
- **Profil olfactif** : à partir des favoris et de la collection, l'app peut déduire les familles olfactives dominantes de l'utilisateur. Comment exposer cette synthèse de manière élégante ? Exemple : "Ton univers est à 60% boisé, 25% oriental, 15% frais". C'est une carte de personnalité, pas un dashboard analytics.
- **Mode hors-ligne** : en parfumerie, le réseau est parfois absent. L'app doit gérer ce cas avec élégance (bannière, contenu dégradé via le cache local) plutôt qu'un échec silencieux.
...
- **Le scan** : l'utilisateur pointe son téléphone vers un flacon. C'est le geste fondateur. Le viseur, l'animation de capture, l'attente (2-3s), le résultat qui apparaît. Si plusieurs correspondances sont trouvées, les résultats sont triés par prix croissant — le meilleur deal en premier.
...
- **La fiche détail** : au-delà de la consultation, c'est un hub d'actions. L'utilisateur peut vouloir :
  ...
  - Comparer le prix en ligne avec le prix en magasin (champ optionnel pour saisir le prix boutique → "Tu économises 38 €")
  - Voir l'historique des prix : le prix actuel est-il une bonne affaire dans l'absolu ou juste le tarif habituel ? Un indicateur de tendance (📉 en baisse / stable / 📈 en hausse) change la perception de l'offre.
...
- **Le catalogue** : l'utilisateur navigue, cherche, compare des parfums sans forcément scanner. Proposer des portes d'entrée thématiques : navigation par famille olfactive (🍃 Frais, 🌲 Boisé, 🕌 Oriental, 🌸 Floral), suggestions personnalisées basées sur les scans/favoris, tendances.
...
- Comment révéler le profil olfactif de l'utilisateur sans tomber dans le dashboard froid ?
- Comment l'app se comporte-t-elle quand le réseau est absent ? Quelle expérience en parfumerie au sous-sol ?
